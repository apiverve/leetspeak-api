...
```gradle
dependencies {
    implementation 'com.github.apiverve:leetspeak-api:1.1.12'
}
```
...
```java
import com.apiverve.leetspeak.LeetSpeakAPIClient;
import com.apiverve.leetspeak.APIResponse;
import com.apiverve.leetspeak.APIException;

// Initialize the client
LeetSpeakAPIClient client = new LeetSpeakAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/leetspeak](https://docs.apiverve.com/ref/leetspeak)
...
- **Documentation:** [https://docs.apiverve.com/ref/leetspeak](https://docs.apiverve.com/ref/leetspeak)
- **Issues:** [GitHub Issues](https://github.com/apiverve/leetspeak-api/issues)
