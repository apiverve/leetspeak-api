# Leet Speak API - Examples

This folder contains example code for using the Leet Speak API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/leetspeak',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
var response = await client.GetAsync("https://api.apiverve.com/v1/leetspeak");
var data = await response.Content.ReadAsStringAsync();
```

## 📚 Documentation

- **API Reference:** [https://docs.apiverve.com/ref/leetspeak](https://docs.apiverve.com/ref/leetspeak)
